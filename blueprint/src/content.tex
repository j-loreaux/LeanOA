...
\begin{proof}
  ...
  of such nonzero projections, by Theorem \ref{lem: sigma_cont_of_normal (Sak 1.7.4)} $q_{\alpha}\to \sup q_{\alpha}$ 
  in the $\sigma$--topology, and by Lemma \ref{lem: proj_of_sup_proj} we know this supremum is a subprojection of $p_1$. Since $\varphi$
